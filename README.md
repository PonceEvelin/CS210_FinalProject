...
After installing Python 3.11.9, you will need to install the libraries we used by running the command "pip install numpy matplotlib pandas scikit-learn tensorflow" in your terminal. This makes sure your computer has all the tools needed to run the machine learning models and show the graphs properly.
